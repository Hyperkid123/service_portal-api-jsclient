...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServicePortalApi.ProviderControlParameters();
  });
  ...
  describe('ProviderControlParameters', function() {
    it('should create an instance of ProviderControlParameters', function() {
      ...
      //var instane = new ServicePortalApi.ProviderControlParameters();
      //expect(instance).to.be.a(ServicePortalApi.ProviderControlParameters);
    });
